...
8. 한국증권거래소 유가증권시장 또는 코스닥시장의 상장법인<신설 2021.03.25.><br>
</div>
`,
    }},
      items: [
  ...
  methods: {
    ...
    set_doc() {
      document.querySelector('#parsing').innerHTML = this.file_data[this.file]['parsing']
      this.view = true
    }
  },
}
